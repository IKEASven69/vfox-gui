...
从 [Releases](https://github.com/IKEASven69/vfox-gui/releases) 下载 `vfox-gui_x64-setup.exe`，双击安装。

### 方式二：便携版

从 Releases 下载 `vfox-gui-portable-x64.zip`，解压后双击 `vfox-gui.exe` 即可运行。无需安装，不写注册表，可放 U 盘。
